...
for datatype in ['train', 'val', 'test']:
    ...
    with open(os.path.join('splits', 'bertinetto', datatype + '.txt'), 'r') as f:
        content = f.readlines()
...
os.remove(tarname)
os.mkdir('data')
os.system('mv train/* data/')
os.system('mv val/* data/')
os.system('mv test/* data/')
os.rmdir('train')
os.rmdir('val')
os.rmdir('test')
